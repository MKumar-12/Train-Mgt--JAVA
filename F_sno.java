...
public class F_sno extends JFrame 
{
	JTextField tF;
	...
	public F_sno() 
	{
		...
		JLabel lblEnter = new JLabel("Enter  the no. of Train whose Record is to be SEARCHED : ");
		lblEnter.setForeground(new Color(255, 69, 0));
		lblEnter.setBounds(45, 70, 400, 15);
		...
		JLabel lblNewLabel_1 = new JLabel("    Train_No        Lcmtv_Type         Name           "
				+ "Source_Stn       Destn_Stn     "
			...
			public void mouseClicked(MouseEvent arg0) 
			{
				try
				{
					...
					while(rs.next())
					{
						...
						p1.setVisible(true);
						model.addRow(new Object[]{rs.getString("t_no"),rs.getString("loco_type"),
								rs.getString("t_name"),rs.getString("source"),
							rs.getString("destn"),rs.getString("n_seats"),rs.getString("fare"),
							rs.getString("n_stops"),rs.getString("n_days_avl")});
						i++;
					}
		...
		btnReset.setBounds(720, 70, 75, 18);
