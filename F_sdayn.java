...
public class F_sdayn extends JFrame 
{
	JTextField tF;
	...
	public F_sdayn() 
	{
		...
		JLabel lblEnter = new JLabel("Enter the day for which operational Train(s) Record is to be SEARCHED : ");
		lblEnter.setForeground(new Color(255, 69, 0));
		lblEnter.setBounds(45, 70, 500, 15);
		getContentPane().add(lblEnter);
		
		tF = new JTextField();
		tF.setHorizontalAlignment(SwingConstants.CENTER);
		tF.setBounds(580, 70, 125, 18);
		...
		{	
			...
			public void mouseClicked(MouseEvent arg0) 
			{
				try
				{
					...
					String load="select * from T_details where days like '%" + s_day + "%'";
		...
		btnReset.setBounds(840, 70, 75, 18);
